...
function getBooksByAvailability(status) {
  let totalPages = 0;
  for (let i = 0; i < bookCollection.length; i++) {
    if (bookCollection[i].isAvailable === status) {
...
const availablePages = getBooksByAvailability(true);
console.log("Total pages of available books: " + availablePages);

const unavailablePages = getBooksByAvailability(false);
console.log("Total pages of unavailable books: " + unavailablePages);
