...
function mergeBookArrays(collection, newCollection) {
  const merged = [...collection, newCollection];

  return merged;
}

console.log(mergeBookArrays(bookCollection, {title: "New Book"}));

// 3. Exercise: Add Keywords (Spread)
// Function Name: addKeywords
// Instruction: Create a function that takes a book object and an array of new keywords. Return a NEW book object with 
// the new keywords added to the existing ones using spread.
