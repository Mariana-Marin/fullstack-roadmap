...
// 1. Exercise: Find by ISBN
// Function Name: findBookByISBN
// Instruction: Use .find() to return the book object that matches a specific ISBN (e.g., "978-0451524935").
...
// Instruction: Use .find() to return the first book published after the year 2010.
...
// Instruction: Use .findIndex() to return the index of the first book that has more than 500 pages.
...
// Instruction: Use .findIndex() to return the index of the first book published by "HarperCollins".
...
// Instruction: Use .findIndex() to return the index of the first book that is NOT available.
