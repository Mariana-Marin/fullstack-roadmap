...
// 1. Exercise: Sort by Year (Ascending)
// Function Name: sortByYearAsc
// Instruction: Use .sort() to order the books by publication year, from oldest to newest.
...
// Instruction: Use .sort() to order the books alphabetically by title.
...
// Instruction: Use .sort() to order the books by number of pages, from shortest to longest.
...
// Instruction: Use .sort() to order the books alphabetically by the author's name.
