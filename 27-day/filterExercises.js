...
// 1. Exercise: Filter Long Books
// Function Name: filterLongBooks
// Instruction: Use the .filter() method to create a new array containing only books that have more than 300 pages.
...
// Instruction: Use .filter() to create an array of books that include "Fantasy" in their `genre` array.
...
// Instruction: Use .filter() to create an array of books published after the year 2000.
...
// Instruction: Use .filter() to create an array of books published by a publisher located in "New York".
